...
python ./src/h5db_builder_cc_sid.py -input ./meta/sanity.aibo_enterface.txt.mspec.out -m_steps 100 -c_ids 0,1 -c_idx 3 -s_idx 2 -c_len 10 --three_d -mt 1:2:4:5:6:7 -out ./h5db/AE.RAW.3cls.av
